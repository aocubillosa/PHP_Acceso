...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Formulario de Integrante
		<br><small>Adicionar/Editar Integrante</small>
	</h4>
</div>
<div class="modal-body">
	<p class="text-danger text-left">Los campos con * son obligatorios.</p>
	<form name="form" id="form" role="form" method="post" >
		<input type="hidden" id="hddId" name="hddId" value="<?php echo $information?$information[0]["id_integrante"]:""; ?>"/>
		<input type="hidden" id="idSchool" name="idSchool" value="<?php echo $idSchool; ?>"/>
		<div class="row">
			<div class="col-sm-4">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="form-group text-left">
					<label class="control-label" for="tipoFuncion">Funcion: *</label>
					<select name="tipoFuncion" id="tipoFuncion" class="form-control" required >
						<option value="">Seleccione...</option>
						<?php for ($i = 0; $i < count($tipo_funcion); $i++) { ?>
							<option value="<?php echo $tipo_funcion[$i]["id_tipo_funcion"]; ?>" <?php if($information && $information[0]["fk_id_tipo_funcion"] == $tipo_funcion[$i]["id_tipo_funcion"]) { echo "selected"; }  ?>><?php echo $tipo_funcion[$i]["tipo_funcion"]; ?></option>
						<?php } ?>
					</select>
				</div>
			</div>
