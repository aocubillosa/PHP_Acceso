		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-qrcode fa-fw"></i> INTEGRANTES - PERMISOS
					</h4>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list"></i> Lista de Permisos de Integrantes
				</div>
					...
					<table width="100%" class="table table-striped table-bordered table-hover small" id="dataTables">
						<thead>
							<tr>
								...
								<th class="text-center">Nombre Integrante</th>
								<th class="text-center">NIT</th>
								<th class="text-center">Escuela</th>
								<th class="text-center">Tipo Función</th>
						...
						<tbody>
						<?php
							foreach ($infoPermisosInt as $lista):
								echo "<tr>";
